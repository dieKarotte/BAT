...
MODEL_CKPT=$SLAM_DIR/outputs/bat-binaural-llama2-qformer-lora/bat-binaural_epoch_5/model.pt
...
QA_ROOT=$SLAM_DIR/examples/seld_spatialsoundqa/dataset/bat_qa_salmonn
STAGE=bat
OUTPUT_DIR=$SLAM_DIR/outputs/bat-binaural-llama2-qformer-lora/doa_eval
