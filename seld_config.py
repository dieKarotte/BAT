...
class TrainConfig:
    ...
    decode_every_epoch: bool = False
    decode_splits: List = field(default_factory=lambda: ["val"])
    decode_max_samples: int = 200
    ...
    decode_output_dir: str = ""
    decode_print_samples: int = 0
